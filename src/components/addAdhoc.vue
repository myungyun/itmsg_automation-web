    ...
    <div style="top: 100px;">
        ...
        <tbody>
            ...
            <tr>
                <td>Argument</td>
                    <td colspan="2">
                        <input type="IP" class="form-control" id="ip" ref="ip" placeholder="Enter Arguments">
                    </td>
            </tr>
            <tr>
                <td>Fork</td>
            ...
            <tr>
                <td>Variable</td>
                <td colspan="2">
                    <b-form-textarea id="privateKey" ref="privateKey" placeholder="Enter Variables" rows="7"
                        max-rows="100">
                    </b-form-textarea>
                </td>
            </tr>
